...
bool LC709203FComponent::begin( void ) 
{
  ...
  setCellCapacity(LC709203F_APA_1000MAH) ;     // jbo to suit the battery I am testing with
...
void LC709203FComponent::setup() {
  ...
  setPowerMode(LC709203F_POWER_OPERATE) ;
  setTemperatureMode(LC709203F_TEMPERATURE_THERMISTOR) ;
  setCellCapacity(LC709203F_APA_1000MAH) ;    // jbo to suit the batery I am testing with
